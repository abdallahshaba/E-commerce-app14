                      ...
                      child: Column(
                        children: [
                         const SizedBox(height: 10,),
                          ...
                          Text("${itemsModel.itemsName}" , style: Styles.boldtextStyle16,),
                         ...
                         const SizedBox(height: 8,),
                          Padding(
                           ...
                           child:  Row(
                            ...
                            children: [
                              Text("${itemsModel.itemsPrice} \$" , style: Styles.boldtextStyle18.copyWith(color: AppColor.kPrimaryColor3),
                              ),
                              IconButton(
                                padding:EdgeInsets.zero,
                                onPressed: (){}, icon: Icon(Icons.favorite , color: AppColor.kPrimaryColor3,))
                            ],
                           ),
                         )
                        ],
